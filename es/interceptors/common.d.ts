...
export declare function authInterceptor(options?: any): {
    request: (config: any) => any;
    responseError: (error: any) => any;
};
export declare function loggingInterceptor(options?: any): {
    request: (config: any) => any;
    response: (response: any) => any;
    responseError: (error: any) => any;
};
export declare function errorHandlingInterceptor(options?: any): {
    responseError: (error: any) => any;
};
export declare function timeoutInterceptor(options?: any): {
    request: (config: any) => any;
    responseError: (error: any) => any;
};
export declare function retryInterceptor(options?: any): {
    request: (config: any) => any;
};
export declare function cacheInterceptor(options?: any): {
    request: (config: any) => any;
};
