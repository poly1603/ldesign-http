...
function getResponseSize(): string {
  if (!props.response?.data)
return '0 B'
...
function getTabBadge(tabKey: string): string | null {
  switch (tabKey) {
    case 'headers':
    ...
    <div v-if="response" class="success-response">
      ...
      <div class="response-meta">
        ...
        <div class="response-actions">
          <button class="action-btn copy-btn" title="复制响应数据" @click="copyResponse">
            📋 复制
          </button>
          <button class="action-btn download-btn" title="下载响应" @click="downloadResponse">
            💾 下载
          </button>
          <button class="action-btn share-btn" title="分享响应" @click="shareResponse">
            🔗 分享
          </button>
        </div>
      </div>
      ...
      <div class="response-tabs">
        <button
          ...
          :key="tab.key"
          class="response-tab" :class="[{ active: activeTab === tab.key }]"
      ...
      <div class="tab-content">
        ...
        <div v-if="activeTab === 'data'" class="response-data">
          <div class="data-toolbar">
            ...
            <div class="data-actions">
              ...
              <button class="format-btn" @click="copyData">
                复制数据
              </button>
            </div>
          </div>
          ...
          <div class="data-content">
            ...
            <div v-else-if="isBinaryData" class="binary-content">
              <div class="binary-info">
                ...
                <button class="download-binary-btn" @click="downloadBinary">
                  下载文件
                </button>
              </div>
            </div>
        ...
        <div v-if="activeTab === 'headers'" class="response-headers">
          <div class="headers-toolbar">
            ...
            <button class="copy-headers-btn" @click="copyHeaders">
              复制所有响应头
            </button>
          </div>
          ...
          <div class="headers-content">
            <div v-for="(value, key) in response.headers" :key="key" class="header-item">
              ...
              <button class="copy-header-btn" title="复制此响应头" @click="copyHeader(key, value)">
                📋
              </button>
            </div>
          </div>
        ...
        <div v-if="activeTab === 'raw'" class="raw-response">
          <div class="raw-toolbar">
            ...
            <button class="copy-raw-btn" @click="copyRawResponse">
              复制原始数据
            </button>
          </div>
        ...
        <div v-if="activeTab === 'curl'" class="curl-command">
          <div class="curl-toolbar">
            ...
            <button class="copy-curl-btn" @click="copyCurl">
              复制 cURL
            </button>
          </div>
        ...
        <div v-if="activeTab === 'timeline'" class="response-timeline">
          ...
          <div class="timeline-chart">
            <div class="timeline-item">
              ...
              <div class="timeline-bar dns-bar" :style="{ width: '10%' }" />
              <div class="timeline-time">
                ~{{ Math.round(responseTime * 0.1) }}ms
              </div>
            </div>
            ...
            <div class="timeline-item">
              ...
              <div class="timeline-bar tcp-bar" :style="{ width: '15%' }" />
              <div class="timeline-time">
            ...
            <div class="timeline-item">
              ...
              <div class="timeline-bar tls-bar" :style="{ width: '20%' }" />
              <div class="timeline-time">
                ~{{ Math.round(responseTime * 0.2) }}ms
              </div>
            </div>
            ...
            <div class="timeline-item">
              ...
              <div class="timeline-bar request-bar" :style="{ width: '5%' }" />
              <div class="timeline-time">
                ~{{ Math.round(responseTime * 0.05) }}ms
              </div>
            </div>
            ...
            <div class="timeline-item">
              ...
              <div class="timeline-bar waiting-bar" :style="{ width: '40%' }" />
              <div class="timeline-time">
            ...
            <div class="timeline-item">
              ...
              <div class="timeline-bar download-bar" :style="{ width: '10%' }" />
              <div class="timeline-time">
                ~{{ Math.round(responseTime * 0.1) }}ms
              </div>
            </div>
