...
export declare function useHttp(): {
    ...
    request: <T = any>(config: RequestConfig) => Promise<import(".").ResponseData<T>>;
    get: <T = any>(url: string, config?: RequestConfig) => Promise<import(".").ResponseData<T>>;
    post: <T = any>(url: string, data?: any, config?: RequestConfig) => Promise<import(".").ResponseData<T>>;
    put: <T = any>(url: string, data?: any, config?: RequestConfig) => Promise<import(".").ResponseData<T>>;
    delete: <T = any>(url: string, config?: RequestConfig) => Promise<import(".").ResponseData<T>>;
    patch: <T = any>(url: string, data?: any, config?: RequestConfig) => Promise<import(".").ResponseData<T>>;
    head: <T = any>(url: string, config?: RequestConfig) => Promise<import(".").ResponseData<T>>;
    options: <T = any>(url: string, config?: RequestConfig) => Promise<import(".").ResponseData<T>>;
...
export declare function useResource<T = any>(baseUrl: string): {
    ...
    list: (params?: Record<string, any>) => Promise<import(".").ResponseData<T[]>>;
    detail: (id: string | number) => Promise<import(".").ResponseData<T>>;
    create: (data: T) => Promise<import(".").ResponseData<T>>;
    update: (id: string | number, data: Partial<T>) => Promise<import(".").ResponseData<T>>;
    patch: (id: string | number, data: Partial<T>) => Promise<import(".").ResponseData<T>>;
    remove: (id: string | number) => Promise<import(".").ResponseData<any>>;
};
/**
 * 分页查询 Hook
 */
export declare function usePagination<T = any>(baseUrl: string, initialPage?: number, initialPageSize?: number): {
    ...
    invalidate: () => void;
    execute: (config?: RequestConfig) => Promise<import(".").ResponseData<{
        data: T[];
        total: number;
        page: number;
        pageSize: number;
    }>>;
    refresh: () => Promise<import(".").ResponseData<{
        data: T[];
        total: number;
        page: number;
        pageSize: number;
    ...
    loading: Ref<boolean>;
    error: Ref<import(".").HttpError | null>;
